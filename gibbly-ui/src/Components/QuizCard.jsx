    ...
    <div className="bg-white shadow-md rounded-lg overflow-hidden">
      ...
      <div className="p-4 w-30 h-30">
        ...
        <div className="mt-4 flex justify-between">
          ...
          <button className="flex items-center justify-center leading-none no-underline text-white text-[25px] rounded-[9px] w-[100px] h-[43px] font-bold border-b-[7px] border-[#9100ff] transition-all duration-200 shadow-md bg-[#2196f3] hover:border-b-[2px] hover:translate-y-[2px]">Host</button>
        </div>
      </div>
    </div>
  );
